...
namespace IDMS.Friendships.Cache
{
            ...
            using (_unitOfWorkManager.Current.SetTenantId(userIdentifier.TenantId))
            {
                var friendCacheItems =
                    (from friendship in _friendshipRepository.GetAll()
                     ...
                     new {userIdentifier.UserId, userIdentifier.TenantId, TargetUserId = friendship.FriendUserId, TargetTenantId = friendship.FriendTenantId, ChatSide = ChatSide.Receiver } equals
                     new {chatMessage.UserId, chatMessage.TenantId, chatMessage.TargetUserId, chatMessage.TargetTenantId, ChatSide = chatMessage.Side } into chatMessageJoined
