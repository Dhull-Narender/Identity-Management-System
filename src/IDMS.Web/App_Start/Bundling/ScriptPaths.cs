...
namespace IDMS.Web.Bundling
{
    public static class ScriptPaths
    {
        ...
        public static string Angular_Localization => GetLocalizationFileForjAngularOrNull(Thread.CurrentThread.CurrentUICulture.Name.ToLower())
        ...
        public static string JQuery_Validation_Localization => GetLocalizationFileForjQueryValidationOrNull(Thread.CurrentThread.CurrentUICulture.Name.ToLower().Replace("-", "_"))
        ...
        public static string JQuery_JTable_Localization => GetLocalizationFileForJTableOrNull(Thread.CurrentThread.CurrentUICulture.Name.ToLower())
        ...
        public static string Bootstrap_Select_Localization => GetLocalizationFileForBootstrapSelect(Thread.CurrentThread.CurrentUICulture.Name.ToLower())
