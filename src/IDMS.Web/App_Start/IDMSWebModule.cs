...
using IDMS.Web.App.Startup;
using IDMS.Web.Areas.Mpa.Startup;
using IDMS.Web.Bundling;
using IDMS.Web.Navigation;
using IDMS.Web.Routing;
using IDMS.WebApi;
...
namespace IDMS.Web
{
    ...
    [DependsOn(
        ...
        typeof(IDMSDataModule),
        typeof(IDMSApplicationModule),
        typeof(IDMSWebApiModule),
    ...
    public class IDMSWebModule : AbpModule
    {
