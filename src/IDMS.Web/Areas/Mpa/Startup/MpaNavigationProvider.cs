...
namespace IDMS.Web.Areas.Mpa.Startup
{
        ...
        public override void SetNavigation(INavigationProviderContext context)
        {
            ...
            menu
                .AddItem(new MenuItemDefinition(
                    ...
                    PageNames.App.Tenant.Basicdata,
　　                L("Basicdata"),
　　                url: "Mpa/Basicdata",
　　                icon: "icon-globe",
                   requiredPermissionName: AppPermissions.Pages_Administration_Basicdata
                ).AddItem(new MenuItemDefinition(
                    PageNames.App.Tenant.SupplierManagement,
　　                L("SupplierManagement"),
　　                url: "Mpa/Product",
　　                icon: "icon-globe",
                   requiredPermissionName: AppPermissions.Pages_Administration_Basicdata
                ))).AddItem(new MenuItemDefinition(
