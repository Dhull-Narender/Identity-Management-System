...
using IDMS.Web.Navigation;
using IDMS.Web.Session;
...
namespace IDMS.Web.Controllers
{
    ...
    /// </summary>
    public class LayoutController : IDMSControllerBase
    {
        ...
        public PartialViewResult AppLogo(string appPath, int width = 168, int height = 33)
        {
            ...
            if (string.IsNullOrEmpty(tenancyName))
            {
                ...
                {
                    ViewBag.TenantCustomLogoUrl = appPath + "Common/Images/app-logo-on-light.jpg";
                }
            }
            else
            {
