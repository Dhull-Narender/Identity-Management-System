...
using IDMS.Authorization.Impersonation;
using IDMS.Authorization.Roles;
using IDMS.Authorization.Users;
using IDMS.Configuration;
using IDMS.Debugging;
using IDMS.MultiTenancy;
using IDMS.Notifications;
using IDMS.Security;
using IDMS.Web.Auth;
using IDMS.Web.Controllers.Results;
using IDMS.Web.Models.Account;
using IDMS.Web.Models.Layout;
using IDMS.Web.MultiTenancy;
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                if (model.IsExternalLogin)
                {
                    ...
                    model.Password = IDMS.Authorization.Users.User.CreateRandomPassword();
